...
<html lang="es">  
  <head>    
    ...
    <meta charset="UTF-8">
    <meta name="title" content="Mercurio">
...
<div class="h-content">
			...
			<div class="hl-cont">
				<div class="hl-top">
					<div class="hl-profile">
						<div class="hl-pic"><a href="perfil.php?username=<?php echo $rowB['username'];?>"><img src="images/1.jpg"<?php echo $rowB['avatar']; ?>" width="50" height="50"></a></div>
					</div>
					<div class="hl-username">
						<div class="hl-name"><a href="perfil.php?username=<?php echo $rowB['username'];?>"><?php echo $rowB['username']; ?></a></div>
						<div class="hl-location">San Miguel, El Salvador</div>
					</div>
				</div>	
				<div class="hl-middle">
	...
	<div class="h-right">		
		...
		<div class="hl-menu">
			<div class="hl-icon"><img src=" " width="50"></div>
		...
		<div class="hr-top">
			<div class="hr-profile">
				<div class="hr-pic"><a href="perfil.php?username=<?php echo $_SESSION['username'];?>"><img src="images/1.jpg"<?php datos_usuario($_SESSION['id'],'avatar'); ?>" width="60" height="60"></a></div>
			</div>
