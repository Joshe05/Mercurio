...
<div class="h-content">
	...
	<div class="p-top">
		<div class="p-foto"><img src="images/1.jpg"<?php echo $rowA['avatar'];?>" width="180" height="180"></div>
		<div class="p-name">
			...
			<div class="p-config"><img src="   "></div>
			<?php } else { ?>
		...
		<div class="p-location">San Miguel, El</div>
